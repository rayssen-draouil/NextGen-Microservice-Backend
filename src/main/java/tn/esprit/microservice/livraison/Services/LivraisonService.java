...
public class LivraisonService {
    ...
    @Autowired
    private tn.esprit.microservice.livraison.client.OrderClient orderClient;
    ...
    public tn.esprit.microservice.livraison.dto.OrderDTO getOrderForDelivery(Integer orderId) {
